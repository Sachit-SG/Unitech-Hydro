...
export function ScrollExpandMedia({
  ...
  const titleHeadingClass = cn(
    "m-0 whitespace-nowrap text-center font-[family-name:var(--font-hero)] text-[clamp(1rem,4vw,1.5rem)] font-extrabold leading-tight tracking-wider text-white drop-shadow-[0_5px_15px_rgba(0,0,0,0.8)] md:text-4xl lg:text-5xl",
